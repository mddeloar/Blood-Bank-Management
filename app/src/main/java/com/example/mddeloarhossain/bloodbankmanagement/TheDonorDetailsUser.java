...
public class TheDonorDetailsUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_donor_details_user);
        ...
        mydatabaseHelper = new MyDatabaseHelper(TheDonorDetailsUser.this);
        SQLiteDatabase sqLiteDatabase = mydatabaseHelper.getWritableDatabase();


        //profileButton = findViewById(R.id.ProfileCardViewId);
        callButton = findViewById(R.id.UserMakeCallCardViewId);
        messageButton = findViewById(R.id.UserSendMessageCardViewId);
        emailButton = findViewById(R.id.UserSendEmailCardViewId);
        //editButton = findViewById(R.id.EditDonorCardViewId);
        //deleteButton = findViewById(R.id.DeleteDonorCardViewId);
        detailsTextview = findViewById(R.id.UserDetailsTextViewId);
        ...
        if (cursor.getCount() == -1) {
            Toast.makeText(TheDonorDetailsUser.this, "No data Found.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(TheDonorDetailsUser.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
                callIntent.setData(Uri.parse("tel:"+call));
                if (ActivityCompat.checkSelfPermission(TheDonorDetailsUser.this,
        ...
        messageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(TheDonorDetailsUser.this);
                ...
                builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //Intent intent = new Intent(TheDonorDetailsUser.this, TheDonorDetails.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(TheDonorDetailsUser.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestId){
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(TheDonorDetailsUser.this, TheDonorDetailsUser.class);
                    //Toast.makeText(MainActivity.this, "You can Log In Now", Toast.LENGTH_SHORT).show();
                    startActivity(intent);
                }
            });
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(TheDonorDetailsUser.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(TheDonorDetailsUser.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(TheDonorDetailsUser.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(TheDonorDetailsUser.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
    ...
    public void showDonorData(String title, String data){
        //Toast.makeText(TheDonorDetailsUser.this, "showdata().", Toast.LENGTH_SHORT).show();
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(TheDonorDetailsUser.this,
