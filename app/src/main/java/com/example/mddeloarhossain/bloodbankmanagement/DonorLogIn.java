...
public class DonorLogIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username.equals("Admin")  && password.equals("12345"))
                {
                    ...
                    Toast.makeText(DonorLogIn.this, "Welcome donor", Toast.LENGTH_SHORT).show();
                    startActivity(intent);
                    mydatabaseHelper = new MyDatabaseHelper(DonorLogIn.this);
        ...
        RegisterRequestButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = (new Intent(DonorLogIn.this, DonorRegistration1.class));
                Toast.makeText(DonorLogIn.this, "You are so great", Toast.LENGTH_SHORT).show();
                startActivity(intent);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(DonorLogIn.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestId){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DonorLogIn.this);
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(DonorLogIn.this, MainActivity.class);
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(DonorLogIn.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(DonorLogIn.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(DonorLogIn.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(DonorLogIn.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(DonorLogIn.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(DonorLogIn.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(DonorLogIn.this,
