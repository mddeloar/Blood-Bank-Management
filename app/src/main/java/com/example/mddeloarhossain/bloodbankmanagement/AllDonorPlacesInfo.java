...
public class AllDonorPlacesInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_donor_places_info);

        mydatabaseHelper = new MyDatabaseHelper(AllDonorPlacesInfo.this);
    ...
    public void loadData() {
        ...
        Cursor cursor = myDatabaseHelper.showAllDonorPlacesData(value);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = (new Intent(AllDonorPlacesInfo.this, TheDonorDetailsUser.class));
                Toast.makeText(AllDonorPlacesInfo.this, "The Donor Details", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(AllDonorPlacesInfo.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestId){
            ...
            android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(AllDonorPlacesInfo.this);
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(AllDonorPlacesInfo.this, AllDonorPlacesInfo.class);
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(AllDonorPlacesInfo.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(AllDonorPlacesInfo.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(AllDonorPlacesInfo.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(AllDonorPlacesInfo.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(AllDonorPlacesInfo.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(AllDonorPlacesInfo.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(AllDonorPlacesInfo.this,
