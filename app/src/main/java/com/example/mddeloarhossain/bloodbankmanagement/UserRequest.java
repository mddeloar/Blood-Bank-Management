...
public class UserRequest extends AppCompatActivity {
    ...
    private EditText NameEditText, EmailEditText,ContactNoEditText, FeedbackEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydatabaseHelper = new MyDatabaseHelper(UserRequest.this);
        SQLiteDatabase sqLiteDatabase = mydatabaseHelper.getWritableDatabase();

        NameEditText = findViewById(R.id.RequestFeedNameEditTextId);
        EmailEditText = findViewById(R.id.RequestFeedEmailEditTextId);
        ContactNoEditText = findViewById(R.id.RequestFeedContactNoEditTextId);
        FeedbackEditText = findViewById(R.id.RequestFeedFeedbackEditTextId);
        SaveButton = findViewById(R.id.RequestSendFeedbackCardViewId);
        ...
        SaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    String request = FeedbackEditText.getText().toString();

                    if (view.getId() == R.id.RequestSendFeedbackCardViewId) {

                        long rowId = mydatabaseHelper.InsertUserRequestData(name, email, contactNo, request);
                        ...
                        if (rowId == -1) {
                            ...
                            builder.setMessage("Successfully send.");
                            builder.setCancelable(true);
                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(UserRequest.this, UserRequest.class);
                                    //Toast.makeText(UserRequest.this, "You can Log In Now", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(UserRequest.this, "Please enter your Email and message", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(UserRequest.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestId){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(UserRequest.this);
            builder.setTitle("Do you to want send message ?");
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(UserRequest.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(UserRequest.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(UserRequest.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(UserRequest.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(UserRequest.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(UserRequest.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(UserRequest.this,
