...
public class SeeTheDonorDetails extends AppCompatActivity {
    private static String call="1";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_see_the_donor_details);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(SeeTheDonorDetails.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestId){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SeeTheDonorDetails.this);
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(SeeTheDonorDetails.this, MainActivity.class);
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(SeeTheDonorDetails.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(SeeTheDonorDetails.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(SeeTheDonorDetails.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(SeeTheDonorDetails.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(SeeTheDonorDetails.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(SeeTheDonorDetails.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(SeeTheDonorDetails.this,
