...
public class AdminSignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydatabaseHelper = new MyDatabaseHelper(AdminSignIn.this);
        ...
        usernameEdittext = findViewById(R.id.AdminSignInusernameId);
        passwordEdittext = findViewById(R.id.AdminSignInpasswordId);
        loginButton = findViewById(R.id.AdminSignInCardViewId);
        textView = findViewById(R.id.AdminSignIntextViewId);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cursor cursor = mydatabaseHelper.RetriveAdminUsernamePassword();
                //Cursor cursor = mydatabaseHelper.showOneDonorData("2");
                //Cursor cursor = mydatabaseHelper.showAllData();
                if (cursor.getCount() == -1) {
                    Toast.makeText(AdminSignIn.this, "No data Found.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                while(cursor.moveToNext()) {
                    ...
                    Apassword = cursor.getString(2);

                }

                if(username.equals(Ausername)  && password.equals(Apassword))
                {
                    Intent intent = (new Intent(AdminSignIn.this, AdminManagePanel.class));
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(AdminSignIn.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestId){
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(AdminSignIn.this);
            ...
            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(AdminSignIn.this, AdminSignIn.class);
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(AdminSignIn.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(AdminSignIn.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(AdminSignIn.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(AdminSignIn.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(AdminSignIn.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(AdminSignIn.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
