...
public class AboutUs extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(AboutUs.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(AboutUs.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(AboutUs.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
