...
public class Feedback extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydatabaseHelper = new MyDatabaseHelper(Feedback.this);
        SQLiteDatabase sqLiteDatabase = mydatabaseHelper.getWritableDatabase();

        NameEditText = findViewById(R.id.FeedNameEditTextId);
        EmailEditText = findViewById(R.id.FeedEmailEditTextId);
        FeedbackEditText = findViewById(R.id.FeedFeedbackEditTextId);
        SaveButton = findViewById(R.id.SendFeedbackCardViewId);
        //FeedbackButton = findViewById(R.id.FeedbackButtonId);
        ...
        SaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (view.getId() == R.id.SendFeedbackCardViewId) {

                        long rowId = mydatabaseHelper.InsertFeedbackData(name, email, feedback);
                        ...
                        if (rowId == -1) {
                            ...
                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    ...
                                    Toast.makeText(Feedback.this, "You can Log In Now", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Feedback.this, "Please enter your Email and message", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(Feedback.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(Feedback.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(Feedback.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
