...
public class DonorRegistration1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_registration1);

        mydatabaseHelper = new MyDatabaseHelper(DonorRegistration1.this);
        SQLiteDatabase sqLiteDatabase = mydatabaseHelper.getWritableDatabase();

        RradioGroup = findViewById(R.id.RegistrationRadioGroupId);
        ///becomeDonor = findViewById(R.id.BecomeDonorRadioGroupId);

        saveButton = findViewById(R.id.RegistrationSaveInfoCardViewId);
        //Button showButton = findViewById(R.id.ShowButtonId);
        RNameEditText = findViewById(R.id.RegistrationEditTextNameId);
        RCityEditText = findViewById(R.id.RegistrationEditTextCityId);
        ///RCityEditText = findViewById(R.id.sityId);
        RLocationEditText = findViewById(R.id.RegistrationEditTextLocationId);
        //BloodGroupEditText = findViewById(R.id.rEditTextBloodGroupId);
        RBirthDateEditText = findViewById(R.id.RegistrationBirthDateEditTextId);
        RContactNoEditText = findViewById(R.id.RegistrationEditTextContactNoId);
        REmailEditText = findViewById(R.id.RegistrationEditTextEmailId);
        RPasswordEditText = findViewById(R.id.RegistrationEditTextPasswordId);

        Rbloodgroup = getResources().getStringArray(R.array.BloodGroup);
        Rspinner  = findViewById(R.id.RegistrationSpinnerBloodGroupId);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(intent);*/
                    ...
                    if (view.getId() == R.id.RegistrationSaveInfoCardViewId) {
                        ...
                        if (rowId == -1) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(DonorRegistration1.this);
                            ...
                            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(DonorRegistration1.this, DonorRegistration1.class);
                            ...
                            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(DonorRegistration1.this, AllDonorInformation.class);
                                    Toast.makeText(DonorRegistration1.this, "You can Log In Now", Toast.LENGTH_SHORT).show();
                                    startActivity(intent);
                                }
                            });
                            ...
                            builder.setNegativeButton("No", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(DonorRegistration1.this, MainActivity.class);
                    ...
                    Toast.makeText(DonorRegistration1.this, "Please enter your information.", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(DonorRegistration1.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(DonorRegistration1.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(DonorRegistration1.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(DonorRegistration1.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(DonorRegistration1.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(DonorRegistration1.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(DonorRegistration1.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(DonorRegistration1.this,
