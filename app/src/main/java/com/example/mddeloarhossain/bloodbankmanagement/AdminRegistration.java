...
public class AdminRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydatabaseHelper = new MyDatabaseHelper(AdminRegistration.this);
        ...
        usernameEdittext = findViewById(R.id.AdminRegistrationusernameId);
        passwordEdittext = findViewById(R.id.AdminRegistrationpasswordId);
        loginButton = findViewById(R.id.AdminRegisterCardViewId);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    long rowId = mydatabaseHelper.InsertAdminRegistrationData(username, password);
                    if (rowId == -1) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(AdminRegistration.this);
                        builder.setTitle("Your data is being inserted..");
                        ...
                        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(AdminRegistration.this, "You can Log In Now", Toast.LENGTH_SHORT).show();
                        ...
                        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(AdminRegistration.this, AllDonorInformation.class);
                                Toast.makeText(AdminRegistration.this, "You can Log In Now", Toast.LENGTH_SHORT).show();
                                startActivity(intent);
                            }
                        });
                    ...
                    Toast.makeText(AdminRegistration.this, "Please enter your information.", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.shareId){
            Toast.makeText(AdminRegistration.this,"Share is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(AdminRegistration.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
            callIntent.setData(Uri.parse("tel:"+call));
            if (ActivityCompat.checkSelfPermission(AdminRegistration.this,
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(AdminRegistration.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.FeedbackId){
            ...
            Intent intent = (new Intent(AdminRegistration.this, Feedback.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.AboutUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(AdminRegistration.this, AboutUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
        if (item.getItemId()==R.id.ContactUsId){
            //Toast.makeText(MainActivity.this,"Feedback is selected.",Toast.LENGTH_SHORT).show();
            Intent intent = (new Intent(AdminRegistration.this, ContactUs.class));
            //Toast.makeText(MainActivity.this, "All Donor Information.", Toast.LENGTH_SHORT).show();
            startActivity(intent);
            return true;
        }
