...
public class MainActivity extends AppCompatActivity {
    ...
    private CardView adminCardView, donorCardView, userCardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donorCardView = findViewById(R.id.DonorCardViewId);
        userCardView = findViewById(R.id.UserCardViewId);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (item.getItemId()==R.id.requestCallId){
            ...
            Toast.makeText(MainActivity.this, "You calling Number is:"+call, Toast.LENGTH_SHORT).show();
        ...
        if (item.getItemId()==R.id.facebooId){
            Toast.makeText(MainActivity.this,"Facebook is selected.",Toast.LENGTH_SHORT).show();
